...
const COURSE_OPTIONS: CourseOption[] = [
  {
    ...
    highlights: [
      'Self-paced 5-phase entrepreneurship curriculum',
      'Learn problem discovery, market basics & AI tools',
      'Fortnightly business challenges',
      'Access to 3 expert fireside chats',
      'Build idea + basic prototype',
      'Present at Demo Day',
  ...
  },
  {
    ...
    highlights: [
      'Everything in Foundation + execution-focused learning',
      'Weekly live hands-on workshops',
      'Access to 7 expert fireside chats',
